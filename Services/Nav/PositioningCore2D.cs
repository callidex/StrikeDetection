...
namespace Services.Nav
{
    ...
    public class PositioningCore2D<T> where T : GeoPoint3D
    {
        ...
        {
            get { return PreviousLocation.Height; }
            set { PreviousLocation.Height = value; }
        }
        ...
        public LocationResult Locate(IEnumerable<T> basePoints)
        {
            ...
            if (typeof(GeoPoint3DD).IsAssignableFrom(typeof(T)))
            {
                Services.Nav.Navigation.TOA_Locate2D(basePoints.Cast<GeoPoint3DD>().ToArray<GeoPoint3DD>(),
                   PreviousLocation.Latitude, PreviousLocation.Longitude, PreviousLocation.Height,
            ...
            return new LocationResult(lat_deg, lon_deg, PreviousLocation.Height, radialError, it_Cnt);
        }
