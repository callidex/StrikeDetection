...
namespace Services.Nav.VLBL
{
    ...
    public class VLBLCore<T> where T : GeoPoint3D, IVLBLMeasurement
    {
        ...
        {
            get { return positioningCore.PreviousLocation.Height; }
            set { positioningCore.PreviousLocation.Height = value; }
        }
        ...
        public void DiscardPrevious()
        {
            ...
            positioningCore.PreviousLocation = new GeoPoint3D(double.NaN, double.NaN, positioningCore.PreviousLocation.Height);
        ...
        public void AddMeasurement(T newMeasurement)
        {
            ...
            if (measurements.IsBaseExists)
            {
                ...
                TargetPositionUpdatedEventHandler.Rise(this,
                    new TargetPositionUpdatedEventArgs(result.Latitude, result.Longitude, result.Height,
