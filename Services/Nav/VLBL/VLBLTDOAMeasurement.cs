...
namespace Services.Nav.VLBL
{
    public class VLBLTDOAMeasurement : GeoPoint3DT, IVLBLMeasurement
    {
        ...
        public VLBLTDOAMeasurement(double lat, double lon, double hgt, double toaS)
            : base(lat, lon, hgt, toaS)
        {
            bearingFromRefPoint = double.NaN;
            distanceToRefPoint = double.NaN;
        }

        public VLBLTDOAMeasurement(double lat, double lon, double hgt, double toaS, GeoPoint3D refPoint)
            : base(lat, lon, hgt, toaS)
        {
